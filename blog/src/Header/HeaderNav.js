    ...
    <main className='mp1'>
      <main className='mainpage'>
        <nav className='Nav'>
          ...
          <a href="#Blog Posts"><abbr title="Projects" style={{textDecoration:"none"}}>Posts</abbr></a>
          <a href="tel:+918667851286"><abbr title="Contact" style={{textDecoration:"none"}}>Contact Me</abbr></a>
        </nav>
      </main>
